            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview <?php if($scriptname === "gravity.php" || $scriptname === "queryads.php"){ ?>active<?php } ?>">
                  ...
                  <ul class="treeview-menu">
                    ...
                    <!-- Category Manage -->
                    <li<?php if($scriptname === "./manage/pihole_category.php"){ ?> class="active"<?php } ?>>
                        <a href="./manage/pihole_category.php">
                            <i class="fa fa-arrow-circle-down"></i> <span>Select Categories</span>
                        </a>
                    </li>
                    <!-- Category Modify -->
                    <li<?php if($scriptname === "./manage/index.php"){ ?> class="active"<?php } ?>>
                        <a href="./manage/index.php">
                            <i class="fa fa-arrow-circle-down"></i> <span>Modify Categories</span>
                        </a>
                    </li>
                    <!-- Query adlists -->
